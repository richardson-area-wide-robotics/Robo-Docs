...
## Repositories
Repositories don't need to be created often, usually before the start of the season or offseason 

### Naming
Name the repository using this format 

`{FIRST-GAME-TYPE}{last-two-numbers-of-game-year}-{game-name}-{optinal-needed-discription}`
